...
def run_palette(_: argparse.Namespace) -> int:
    ...
    print(f"21. {PRIMARY_CLI} agent creator-studio codex")
    print(f"22. {PRIMARY_CLI} program init")
    print(f"23. {PRIMARY_CLI} program status")
    print(f"24. {PRIMARY_CLI} program plan --write-report")
    print(f"25. {PRIMARY_CLI} program loop --iterations 1 --apply-safe --write-report")
    print(f"26. {PRIMARY_CLI} program daemon --apply-guardrails")
    print(f"27. {PRIMARY_CLI} program phases --refresh-state")
    print(f"28. {PRIMARY_CLI} program promote")
    print(f"29. {PRIMARY_CLI} program complete")
